...
import { PurchaseSaleComparison } from '../../types';

interface PurchaseSaleTableProps {
  data: PurchaseSaleComparison[];
  headers: string[];
}

export const PurchaseSaleTable: React.FC<PurchaseSaleTableProps> = ({ data, headers }) => {
  return (
