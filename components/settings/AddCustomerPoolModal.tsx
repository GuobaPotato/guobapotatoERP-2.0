...
interface AddCustomerPoolModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const AddCustomerPoolModal: React.FC<AddCustomerPoolModalProps> = ({ isOpen, onClose }) => {
    ...
    >
      ...
      >
        ...
        <div className="flex justify-between items-center p-5 border-b border-slate-200">
          <h2 className="text-lg font-bold text-slate-800">添加客户池</h2>
        ...
        <div className="p-6 space-y-5">
          <div>
            <label className={requiredLabelClass}>客户池名称</label>
            <input 
              type="text" 
