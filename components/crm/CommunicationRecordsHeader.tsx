...
interface CommunicationRecordsHeaderProps {
  activeTab: string;
  setActiveTab: (tab: string) => void;
}

export const CommunicationRecordsHeader: React.FC<CommunicationRecordsHeaderProps> = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <div className="px-6 pt-4 border-b border-slate-200 bg-white">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
        <h1 className="text-xl font-bold text-slate-800">沟通记录</h1>
