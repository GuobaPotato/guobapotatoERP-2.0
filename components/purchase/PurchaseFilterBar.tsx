...
export const PurchaseFilterBar: React.FC = () => {
  return (
    <div className="p-4 md:px-6 md:py-4 flex flex-col md:flex-row items-center space-y-3 md:space-y-0 md:space-x-4 bg-slate-50/50 border-b border-slate-200">
      <div className="w-full md:w-auto">
        <button className="w-full md:w-auto flex items-center justify-between text-left bg-white text-slate-700 px-4 py-2 rounded-lg border border-slate-300 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-blue-500 transition-colors duration-200 shadow-sm">
          <span>选择部门或下属</span>
          <ChevronDownIcon className="ml-2 text-slate-400" />
        </button>
      </div>
